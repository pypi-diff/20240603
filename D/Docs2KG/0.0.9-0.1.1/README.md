# Comparing `tmp/docs2kg-0.0.9.tar.gz` & `tmp/docs2kg-0.1.1.tar.gz`
...
### Comparing `docs2kg-0.0.9/examples/demo/pdf_exported.py` & `docs2kg-0.1.1/examples/demo/pdf_exported.py`
