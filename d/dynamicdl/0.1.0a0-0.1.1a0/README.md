# Comparing `tmp/dynamicdl-0.1.0a0.tar.gz` & `tmp/dynamicdl-0.1.1a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dynamicdl-0.1.0a0.tar", last modified: Mon May 13 23:47:10 2024, max compression
+gzip compressed data, was "dynamicdl-0.1.1a0.tar", last modified: Mon Jun  3 08:40:17 2024, max compression
```

## Comparing `dynamicdl-0.1.0a0.tar` & `dynamicdl-0.1.1a0.tar`

### file list

```diff
@@ -1,20 +1,54 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-13 23:47:10.252930 dynamicdl-0.1.0a0/
--rw-r--r--   0 runner    (1001) docker     (127)    11357 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     1539 2024-05-13 23:47:10.252930 dynamicdl-0.1.0a0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      747 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-13 23:47:10.248931 dynamicdl-0.1.0a0/dynamicdl/
--rw-r--r--   0 runner    (1001) docker     (127)      158 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     6716 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/_utils.py
--rw-r--r--   0 runner    (1001) docker     (127)    25689 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/data_items.py
--rw-r--r--   0 runner    (1001) docker     (127)    60822 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/dynamicdl.py
--rw-r--r--   0 runner    (1001) docker     (127)    26322 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/processing.py
--rw-r--r--   0 runner    (1001) docker     (127)     7596 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/dynamicdl/transforms.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-13 23:47:10.252930 dynamicdl-0.1.0a0/dynamicdl.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     1539 2024-05-13 23:47:10.000000 dynamicdl-0.1.0a0/dynamicdl.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      342 2024-05-13 23:47:10.000000 dynamicdl-0.1.0a0/dynamicdl.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-13 23:47:10.000000 dynamicdl-0.1.0a0/dynamicdl.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      304 2024-05-13 23:47:10.000000 dynamicdl-0.1.0a0/dynamicdl.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       10 2024-05-13 23:47:10.000000 dynamicdl-0.1.0a0/dynamicdl.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)     1036 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-13 23:47:10.252930 dynamicdl-0.1.0a0/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      930 2024-05-13 23:47:02.000000 dynamicdl-0.1.0a0/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.405686 dynamicdl-0.1.1a0/
+-rw-r--r--   0 runner    (1001) docker     (127)    11357 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)     1539 2024-06-03 08:40:17.405686 dynamicdl-0.1.1a0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      747 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/README.md
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.397686 dynamicdl-0.1.1a0/dynamicdl/
+-rw-r--r--   0 runner    (1001) docker     (127)      140 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.401686 dynamicdl-0.1.1a0/dynamicdl/_main/
+-rw-r--r--   0 runner    (1001) docker     (127)       70 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_main/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2455 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_main/_collate.py
+-rw-r--r--   0 runner    (1001) docker     (127)    14185 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_main/_engine.py
+-rw-r--r--   0 runner    (1001) docker     (127)     7594 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_main/_transforms.py
+-rw-r--r--   0 runner    (1001) docker     (127)      861 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_main/_utils.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1226 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_utils.py
+-rw-r--r--   0 runner    (1001) docker     (127)     7083 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/_warnings.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2349 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/config.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.401686 dynamicdl-0.1.1a0/dynamicdl/data/
+-rw-r--r--   0 runner    (1001) docker     (127)      338 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     6725 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/dataentry.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2444 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/dataitem.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1608 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/datatype.py
+-rw-r--r--   0 runner    (1001) docker     (127)    10432 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/datatypes.py
+-rw-r--r--   0 runner    (1001) docker     (127)     3946 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/partialtype.py
+-rw-r--r--   0 runner    (1001) docker     (127)     4361 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/data/tokens.py
+-rw-r--r--   0 runner    (1001) docker     (127)    49774 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/dynamicdl.py
+-rw-r--r--   0 runner    (1001) docker     (127)     6632 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/dynamicds.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.401686 dynamicdl-0.1.1a0/dynamicdl/parsing/
+-rw-r--r--   0 runner    (1001) docker     (127)      684 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2789 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/alias.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2541 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/ambiguouslist.py
+-rw-r--r--   0 runner    (1001) docker     (127)    11624 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/generic.py
+-rw-r--r--   0 runner    (1001) docker     (127)     3179 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/genericlist.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1848 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/impliedlist.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1389 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/namespace.py
+-rw-r--r--   0 runner    (1001) docker     (127)     6794 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/pairing.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2979 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/segmentationobject.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2042 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/parsing/static.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.405686 dynamicdl-0.1.1a0/dynamicdl/processing/
+-rw-r--r--   0 runner    (1001) docker     (127)      476 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1946 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/csvfile.py
+-rw-r--r--   0 runner    (1001) docker     (127)      356 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/datafile.py
+-rw-r--r--   0 runner    (1001) docker     (127)      877 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/images.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2450 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/jsonfile.py
+-rw-r--r--   0 runner    (1001) docker     (127)     7635 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/txtfile.py
+-rw-r--r--   0 runner    (1001) docker     (127)     3125 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/xmlfile.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1961 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/dynamicdl/processing/yamlfile.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-06-03 08:40:17.405686 dynamicdl-0.1.1a0/dynamicdl.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     1539 2024-06-03 08:40:17.000000 dynamicdl-0.1.1a0/dynamicdl.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     1242 2024-06-03 08:40:17.000000 dynamicdl-0.1.1a0/dynamicdl.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-06-03 08:40:17.000000 dynamicdl-0.1.1a0/dynamicdl.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)      304 2024-06-03 08:40:17.000000 dynamicdl-0.1.1a0/dynamicdl.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       10 2024-06-03 08:40:17.000000 dynamicdl-0.1.1a0/dynamicdl.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (127)     1112 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-06-03 08:40:17.405686 dynamicdl-0.1.1a0/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)      960 2024-06-03 08:40:08.000000 dynamicdl-0.1.1a0/setup.py
```

### Comparing `dynamicdl-0.1.0a0/LICENSE` & `dynamicdl-0.1.1a0/LICENSE`

 * *Files identical despite different names*

### Comparing `dynamicdl-0.1.0a0/PKG-INFO` & `dynamicdl-0.1.1a0/PKG-INFO`
...
+Version: 0.1.1a0
 ...
 Home-page: https://github.com/ESB-AI-Lab/DynamicDL
 Author: Anthony Tong
...
### Comparing `dynamicdl-0.1.0a0/README.md` & `dynamicdl-0.1.1a0/README.md`

 * *Files identical despite different names*

### Comparing `dynamicdl-0.1.0a0/dynamicdl/_utils.py` & `dynamicdl-0.1.1a0/dynamicdl/_warnings.py`
...
### Comparing `dynamicdl-0.1.0a0/dynamicdl/dynamicdl.py` & `dynamicdl-0.1.1a0/dynamicdl/dynamicdl.py`
...
### Comparing `dynamicdl-0.1.0a0/dynamicdl/transforms.py` & `dynamicdl-0.1.1a0/dynamicdl/_main/_transforms.py`
...
### Comparing `dynamicdl-0.1.0a0/dynamicdl.egg-info/PKG-INFO` & `dynamicdl-0.1.1a0/dynamicdl.egg-info/PKG-INFO`
...
### Comparing `dynamicdl-0.1.0a0/pyproject.toml` & `dynamicdl-0.1.1a0/pyproject.toml`
...
### Comparing `dynamicdl-0.1.0a0/setup.py` & `dynamicdl-0.1.1a0/setup.py`
