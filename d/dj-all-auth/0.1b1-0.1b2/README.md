# Comparing `tmp/dj_all_auth-0.1b1.tar.gz` & `tmp/dj_all_auth-0.1b2.tar.gz`
...
## Comparing `dj_all_auth-0.1b1.tar` & `dj_all_auth-0.1b2.tar`
...
### Comparing `dj_all_auth-0.1b1/PKG-INFO` & `dj_all_auth-0.1b2/PKG-INFO`
...
### Comparing `dj_all_auth-0.1b1/README.rst` & `dj_all_auth-0.1b2/README.rst`
...
### Comparing `dj_all_auth-0.1b1/dj_all_auth/__init__.py` & `dj_all_auth-0.1b2/dj_all_auth/__init__.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/admin.py` & `dj_all_auth-0.1b2/dj_all_auth/admin.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/base_models.py` & `dj_all_auth-0.1b2/dj_all_auth/base_models.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/context_processors.py` & `dj_all_auth-0.1b2/dj_all_auth/context_processors.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/lib/Mail.py` & `dj_all_auth-0.1b2/dj_all_auth/lib/Mail.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/migrations/0001_initial.py` & `dj_all_auth-0.1b2/dj_all_auth/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/auth/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/auth/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/discord/Discord.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/discord/Discord.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/discord/models.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/discord/models.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/discord/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/discord/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/google/Google.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/google/Google.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/google/models.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/google/models.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/google/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/google/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/steam/Steam.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/steam/Steam.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/steam/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/steam/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/twitch/Twitch.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/twitch/Twitch.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/twitch/models.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/twitch/models.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/connections/twitch/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/connections/twitch/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/profile/models.py` & `dj_all_auth-0.1b2/dj_all_auth/services/profile/models.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/services/profile/views.py` & `dj_all_auth-0.1b2/dj_all_auth/services/profile/views.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/urls.py` & `dj_all_auth-0.1b2/dj_all_auth/urls.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/utils/TokenGenerator.py` & `dj_all_auth-0.1b2/dj_all_auth/utils/TokenGenerator.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth/utils/forms.py` & `dj_all_auth-0.1b2/dj_all_auth/utils/forms.py`

 * *Files identical despite different names*

### Comparing `dj_all_auth-0.1b1/dj_all_auth.egg-info/PKG-INFO` & `dj_all_auth-0.1b2/dj_all_auth.egg-info/PKG-INFO`
...
### Comparing `dj_all_auth-0.1b1/setup.cfg` & `dj_all_auth-0.1b2/setup.cfg`
