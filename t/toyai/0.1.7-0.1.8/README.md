# Comparing `tmp/toyai-0.1.7-py3-none-any.whl.zip` & `tmp/toyai-0.1.8-py3-none-any.whl.zip`
...
## Comparing `toyai-0.1.7.dist-info/RECORD` & `toyai-0.1.8.dist-info/RECORD`
